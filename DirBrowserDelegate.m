...
- (NSInteger)browser:(NSBrowser *)sender numberOfRowsInColumn:(NSInteger)n {
	...
	if (n == 0) {
		...
		NSArray *directoryContents = [fm contentsOfDirectoryAtURL:[NSURL fileURLWithPath:resolvedPath isDirectory:YES] includingPropertiesForKeys:@[NSURLIsDirectoryKey,NSURLIsHiddenKey] options:0 error:NULL];
